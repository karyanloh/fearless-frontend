...
class LocationForm extends React.Component{
    ...
    async handleSubmit(event){
        ...
        const data = {...this.state}; //create copy of this.state
        data.room_count = data.roomCount; //create new key(room_count) to match our data from source code
        delete data.roomCount;//deleting so we dont send it back to the server
        delete data.states;//deleting so we dont send it back to the server
        console.log(data)
